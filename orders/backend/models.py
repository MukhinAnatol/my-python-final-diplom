...
class Shop(models.Model):
    ...
    filename = models.CharField(max_length=100, verbose_name='Имя файла', null=True, blank=True)
...
class Contact(models.Model):
    ...
    type = models.CharField(max_length=40, choices=CONTACT_CHOICES,
...
class Order(models.Model):
    ...
    status = models.CharField(verbose_name='Статус', choices=STATE_CHOICES, max_length=20, default='new')
